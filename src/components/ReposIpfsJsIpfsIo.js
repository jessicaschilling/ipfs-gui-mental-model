...
import savvy from '../img/savvy-js-ipfs-io.svg';
...
const ReposIpfsJsIpfsIo = () => (
  <div id='content' className='pt3 pr4 pl4 w-100'>
    ...
    <div className='chart-box'>
      <div>
        <dl>
          <dd class='percentage percentage-15'><span class='percentage-label'>Disaster resilience/recovery</span></dd>
          <dd class='percentage percentage-15'><span class='percentage-label'>Corporate/gov't freedom</span></dd>
          <dd class='percentage percentage-15'><span class='percentage-label'>Data integrity</span></dd>
          <dd class='percentage percentage-15'><span class='percentage-label'>Self-sovereign identity</span></dd>
          <dd class='percentage percentage-15'><span class='percentage-label'>File storage/retrieval</span></dd>
          <dd class='percentage percentage-15'><span class='percentage-label'>File streaming</span></dd>
          <dd class='percentage percentage-15'><span class='percentage-label'>Permanent archiving</span></dd>
          <dd class='percentage percentage-15'><span class='percentage-label'>Big data</span></dd>
