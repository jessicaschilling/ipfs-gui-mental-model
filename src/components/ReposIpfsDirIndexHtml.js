...
import savvy from '../img/savvy-dir-index-html.svg';
import { NavLink } from 'react-router-dom';

const ReposIpfsDirIndexHtml = () => (
      ...
      <div className='chart-box'>
        <div>
          <dl>
            ...
            <dd class='percentage percentage-20'><span class='percentage-label'>Corporate/gov't freedom</span></dd>
            ...
            <dd class='percentage percentage-20'><span class='percentage-label'>Permanent archiving</span></dd>
            <dd class='percentage percentage-20'><span class='percentage-label'>Big data</span></dd>
...
export default ReposIpfsDirIndexHtml;
