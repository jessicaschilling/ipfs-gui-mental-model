...
import savvy from '../img/savvy-ipfs-companion.svg';
import { NavLink } from 'react-router-dom';

const ReposIpfsShipyardIpfsCompanion = () => (
  <div id='content' className='pt3 pr4 pl4 w-100'>
    <h1><span className='nav-category'>Repo:</span> ipfs-shipyard/ipfs-companion</h1>

    <p>This repo contains the source code for IPFS Companion, a browser extension for Firefox and Chromium that simplifies access to IPFS resources on the web. <a href="https://github.com/ipfs-shipyard/ipfs-companion" target="_blank" rel="noopener noreferrer">View on GitHub</a></p>
    ...
    <div className='chart-box'>
      <div>
        <dl>
          ...
          <dd class='percentage percentage-5'><span class='percentage-label'>Corporate/gov't freedom</span></dd>
          <dd class='percentage percentage-25'><span class='percentage-label'>Data integrity</span></dd>
          <dd class='percentage percentage-5'><span class='percentage-label'>Self-sovereign identity</span></dd>
          <dd class='percentage percentage-100'><span class='percentage-label'>File storage/retrieval</span></dd>
          <dd class='percentage percentage-5'><span class='percentage-label'>File streaming</span></dd>
          <dd class='percentage percentage-25'><span class='percentage-label'>Permanent archiving</span></dd>
          <dd class='percentage percentage-5'><span class='percentage-label'>Big data</span></dd>
...
export default ReposIpfsShipyardIpfsCompanion;
