...
const ToolsMiscInfoDownloadresources = () => (
  <div id='content' className='pt3 pr4 pl4 w-100'>
    ...
    <div className='chart-box'>
      ...
      <NavLink to='/repos/ipfs/ipfs-docs'><span className='f4 grow no-underline br3 ba bw1 ph3 pv2 ma2 dib teal bg-white'><code>ipfs-docs</code></span></NavLink>
      <NavLink to='/repos/ipfs/js-ipfs-io'><span className='f4 grow no-underline br3 ba bw1 ph3 pv2 ma2 dib teal bg-white'><code>js.ipfs.io</code></span></NavLink>
      <NavLink to='/repos/ipfs/website'><span className='f4 grow no-underline br3 ba bw1 ph3 pv2 ma2 dib teal bg-white'><code>website</code></span></NavLink>
